...
def scrape_article(key, url):
    ...
    for article in articles:
        headlines = article.find('h2', class_='tm-article-snippet__title tm-article-snippet__title_h2').text
        ...
        for words in key:
            if (words.lower() in headlines.lower()) or (words.lower() in post_text.lower()):
                print(f'Дата: {date_post} - Заголовок: {headlines} - Ссылка: https://habr.com{post_link}')
